...
const AccPage = () => {
  return (
    ...
    >
      ...
      {/* Hero Section */}
      <section className="py-20 bg-[#F0F7FF] text-center relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full opacity-5 bg-[url('https://www.transparenttextures.com/patterns/clean-gray-paper.png')]"></div>
